...
> 参赛项目：**小笼文档问答（xiaolong-doc-qa）** — 把公开的飞书文档变成可问答的知识库
...
| **赛道二 · Skill 创作** | 把「文档 → 知识库问答」这套方法做成可复用的 Skill（xiaolong-doc-qa），附使用说明 + 一次真实运行结果 | [track2-skill-creation.md](track2-skill-creation.md) |
...
使用说明（3 步）：① 豆包工作侧边栏「技能·连接器·伙伴」→ 技能 → 导入 xiaolong-doc-qa.zip；② 把公开的飞书文档链接发给豆包工作（文档分享权限设为「互联网上获得链接的人可阅读」）；③ 任意提问，回答带出处；也可说「基于文档出 5 道题」。
